...
namespace Modules.Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20250716051933_intialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Infrastructure.Inbox.InboxConsumerMessage", b =>
                {
                    ...
                    b.ToTable("inbox_consumer_message", "catalog");
                });
            ...
            modelBuilder.Entity("Common.Infrastructure.Outbox.OutboxConsumerMessage", b =>
                {
                    ...
                    b.ToTable("outbox_consumer_message", "catalog");
                });
            ...
            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Banner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("banner", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Brand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Modules.Catalog.Domain.Entities.CategorySpec", b =>
                {
                    ...
                    b.HasKey("CategoryId", "SpecId")
                        .HasName("pk_category_spec");

                    b.HasIndex("SpecId")
                        .HasDatabaseName("ix_category_spec_spec_id");

                    b.ToTable("category_spec", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Color", b =>
                {
            ...
            modelBuilder.Entity("Modules.Catalog.Domain.Entities.ProductItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("product_item", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.ProductItemOptionColor", b =>
                {
                    ...
                    b.ToTable("product_item_option_color", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.ProductItemOptionNumeric", b =>
                {
                    b.Property<Guid>("ProductItemId")
                        .HasColumnType("uuid")
                        .HasColumnName("product_item_id");
                    ...
                    b.ToTable("product_item_option_numeric", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.ProductItemOptions", b =>
                {
                    b.Property<Guid>("ProductItemId")
                        .HasColumnType("uuid")
                        .HasColumnName("product_item_id");
                    ...
                    b.ToTable("product_item_options", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Specification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("specification", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.SpecificationOption", b =>
                {
                    b.Property<Guid>("SpecificationId")
                        .HasColumnType("uuid")
                        .HasColumnName("specification_id");
                    ...
                    b.ToTable("specification_option", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Translation.BrandTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("brand_translation", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Translation.CategoryTranslation", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("integer")
                        .HasColumnName("category_id");
                    ...
                    b.ToTable("category_translation", "catalog");
            ...
            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Translation.ProductTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("product_translation", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Translation.SpecificationTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("specification_translation", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Vendor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("vendor", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Views.CategoryStatistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("category_statistics", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Views.SpecificationStatistics", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("specification_statistics", "catalog");
                });

            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Category", b =>
                {
                    b.HasOne("Modules.Catalog.Domain.Entities.Category", "ParentCategory")
            ...
            modelBuilder.Entity("Modules.Catalog.Domain.Entities.CategorySpec", b =>
                {
                    ...
                    b.HasOne("Modules.Catalog.Domain.Entities.Specification", "Specification")
                        .WithMany("CategorySpecs")
            ...
            modelBuilder.Entity("Modules.Catalog.Domain.Entities.Product", b =>
                {
                    b.HasOne("Modules.Catalog.Domain.Entities.Brand", "Brand")
                        .WithMany("Products")
                    ...
                    b.HasOne("Modules.Catalog.Domain.Entities.Vendor", "Vendor")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Modules.Catalog.Domain.Entities.ProductItemOptionColor", b =>
                {
                    b.HasOne("Modules.Catalog.Domain.Entities.Color", "Color")
                    ...
                    b.HasOne("Modules.Catalog.Domain.Entities.ProductItem", "ProductItem")
                        .WithMany("ProductItemOptionColors")
            ...
            modelBuilder.Entity("Modules.Catalog.Domain.Entities.ProductItemOptions", b =>
                {
                    ...
                    b.HasOne("Modules.Catalog.Domain.Entities.SpecificationOption", "SpecificationOptions")
                        .WithMany("ProductItemOptions")
