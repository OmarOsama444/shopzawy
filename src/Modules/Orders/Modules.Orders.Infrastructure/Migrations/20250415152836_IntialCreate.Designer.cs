...
namespace Modules.Orders.Infrastructure.Migrations
{
    ...
    [Migration("20250415152836_IntialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modules.Orders.Domain.Entities.ProductSpecificationValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("CategorySpecId")
                        .HasColumnType("uuid")
                        .HasColumnName("category_spec_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_specification_value");

                    b.HasIndex("CategorySpecId")
                        .HasDatabaseName("ix_product_specification_value_category_spec_id");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_product_specification_value_product_id");

                    b.ToTable("product_specification_value", "orders");
                });
            ...
            modelBuilder.Entity("Modules.Orders.Domain.Entities.Category", b =>
                {
                    b.HasOne("Modules.Orders.Domain.Entities.Category", null)
            ...
            modelBuilder.Entity("Modules.Orders.Domain.Entities.ProductSpecificationValue", b =>
                {
                    b.HasOne("Modules.Orders.Domain.Entities.CategorySpecification", "CategorySpecification")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_specification_value_category_specification_category");
                    ...
                    b.HasOne("Modules.Orders.Domain.Entities.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_specification_value_product_product_id");
